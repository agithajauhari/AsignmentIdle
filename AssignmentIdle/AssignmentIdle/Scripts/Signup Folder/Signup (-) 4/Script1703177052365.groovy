...
WebUI.setText(findTestObject('Object Repository/Page_Daftar  Tokopedia/input_Nama Lengkap_regis-fullname'), '')

WebUI.setText(findTestObject('Object Repository/Page_Daftar  Tokopedia/input_Kata Sandi_regis-password'), '')

WebUI.verifyElementNotClickable(findTestObject('Page_Daftar  Tokopedia/button_Selesai'))
