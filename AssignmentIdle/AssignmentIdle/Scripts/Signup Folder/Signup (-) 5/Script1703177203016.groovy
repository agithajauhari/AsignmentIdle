...
WebUI.setText(findTestObject('Object Repository/Page_Daftar  Tokopedia/input_Nama Lengkap_regis-fullname'), 'Hasiah')

WebUI.setText(findTestObject('Object Repository/Page_Daftar  Tokopedia/input_Kata Sandi_regis-password'), 'asd')

WebUI.verifyElementPresent(findTestObject('Page_Daftar  Tokopedia/p_Kata sandi terlalu pendek, minimum 8 karakter'), 0)
