...
WebUI.click(findTestObject('Page_Situs Jual Beli Online Terlengkap, Mud_c2d1e5/button_Masuk'))
...
WebUI.click(findTestObject('Object Repository/Page_Jual AccentAmbios - 20s Tshirt Kaos Bo_ee17a9/span_Beli Langsung'))

WebUI.click(findTestObject('Page_Jual AccentAmbios - 20s Tshirt Kaos Boxy Cut Oversize Pria Wanita BTBAwesom - XL - Kota Bandung - AccentAmbios  Tokopedia/p_BCA Virtual Account'))

WebUI.click(findTestObject('Object Repository/Page_Jual AccentAmbios - 20s Tshirt Kaos Bo_ee17a9/div_Saldo tidak cukup_express-icon-arrow-right'))
